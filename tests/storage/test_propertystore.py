...
from graphene.storage.propertystore import *
...
class TestPropertyStoreMethods(unittest.TestCase):
    ...
    def test_write_read_1_property(self):
        ...
        db_property_file = property_store.property_at_index(db_property.index)
    ...
    def test_overwrite_property(self):
        ...
        new_property2 = Property(3, False, Property.PropertyType.stringArray,
                                 6, 9, 12, 15)
        property_store.write_property(new_property2)
        ...
        new_property2_file = \
            property_store.property_at_index(new_property2.index)
